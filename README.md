...
* **`onPress`** _(Function(`context`, `message`))_ - Callback when a message bubble is pressed; This is helpful to implement rich cards chats (when a user receives a set of options and clicks a pre-written question).
